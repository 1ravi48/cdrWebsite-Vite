...
//             </div>
//             <div className={styles.teamMemberContent}>
//               <span className={styles.teamMemberTitle}>Software Developer</span>
//               <h3 className={styles.teamMemberName}>Catherine Sarquís</h3>
//               <p className={styles.teamMemberDescription}>
//                 Catherine is transitioning into software development, driven by
//                 her passion for detail and problem-solving. Catherine&apos;s
//                 experience in proofreading, digital editing and love of
//                 languages bring a unique perspective to her work.
//               </p>
//               <button className={styles.readMoreBtn}>View More</button>
//             </div>
//           </div>
